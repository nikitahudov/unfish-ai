...
export default function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    // If successful without email confirmation, auth state change will redirect
  };
  ...
  const handleGoogleSignup = async () => {
    ...
    // Google OAuth will redirect to callback
  };
  ...
  return (
    <div className="bg-slate-800 rounded-2xl border border-slate-700 p-8">
      ...
      <p className="text-slate-400 text-center mb-6">
        Start your journey to poker mastery
      </p>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full flex items-center justify-center gap-3 py-3 bg-white hover:bg-gray-100 disabled:bg-gray-300 disabled:cursor-not-allowed text-gray-800 font-medium rounded-lg transition-colors"
      >
