...
export function Footer() {
  ...
  const footerLinks = {
    learn: [
      { label: 'Curriculum', href: '/wiki' },
      { label: 'Assessment', href: '/assess' },
      { label: 'AI Coach', href: '/coach' },
    ],
    tools: [
      { label: 'GTO Charts', href: '/tools/gto-charts' },
      { label: 'Range Builder', href: '/tools/range-viewer' },
      { label: 'Pot Odds Calculator', href: '/tools/pot-odds' },
                ...
                <li key={link.href}>
                  {link.comingSoon ? (
                    <span className="text-sm text-slate-500 cursor-not-allowed">
                      {link.label}
                      <span className="ml-1 text-xs bg-slate-700 px-1.5 py-0.5 rounded">Soon</span>
                    </span>
                  ) : (
                    <Link
                      href={link.href}
